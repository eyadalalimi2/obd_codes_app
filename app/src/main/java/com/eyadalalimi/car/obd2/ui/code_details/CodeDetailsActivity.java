package com.eyadalalimi.car.obd2.ui.code_details;
...
import com.eyadalalimi.car.obd2.viewmodel.CodeDetailViewModel;
...
public class CodeDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        boolean isOnline = NetworkUtil.isConnected(this);
        if (isOnline) {
